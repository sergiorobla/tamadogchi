const porcentajes = document.querySelectorAll(".porcentaje") as NodeListOf<HTMLElement>;
const aumentarAnchoBotones = document.querySelectorAll(".aumentar") as NodeListOf<HTMLImageElement>;
const numerosPorcentaje = document.querySelectorAll(".numeroPorcentaje") as NodeListOf<HTMLElement>;
...
aumentarAnchoBotones.forEach((boton, index) => {
  boton.addEventListener("click", function () {
    const porcentaje = boton.parentElement?.querySelector(".porcentaje") as HTMLElement;
